...
class CreateAuthTables extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            'user_image'        => ['type' => 'varchar', 'constraint' => 255, 'default' => 'undraw_profile.png'],
            'nip'               => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
            'fullname'          => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
            'nickname'          => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
